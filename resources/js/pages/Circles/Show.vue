    ...
    <AppLayout :title="circle.name">
        ...
        <div class="bg-white px-4 py-4 dark:bg-sand-900">
            <div class="flex items-center gap-3">
                <div class="flex size-14 items-center justify-center rounded-full bg-sage-100 dark:bg-sage-800">
        ...
        <div class="mt-2 bg-white dark:bg-sand-900">
            <div class="flex items-center justify-between border-b border-sand-100 px-4 py-3 dark:border-sand-800">
                ...
                <button class="text-sage-600 dark:text-sage-400" @click="resetAddMember">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                    ...
                    <div v-if="showInviteByEmail" class="mt-3 rounded-lg border border-sand-200 bg-sand-50 p-3 dark:border-sand-700 dark:bg-sand-800">
                        ...
                        <form class="flex items-center gap-2" @submit.prevent="inviteMember">
                            <input
                                ...
                                class="flex-1 rounded-lg border border-sand-200 bg-white px-3 py-2 text-sm text-sand-800 placeholder-sand-400 focus:border-sage-400 focus:outline-none dark:border-sand-700 dark:bg-sand-900 dark:text-sand-100 dark:placeholder-sand-500"
                            />
                            <button
                                type="submit"
                                class="rounded-lg bg-sage-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-50 dark:bg-sage-700"
